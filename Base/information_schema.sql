...
--
-- Host: localhost:3306
-- Tempo de geração: 13/08/2025 às 10:20
...
--
-- Estrutura stand-in para view `ADMINISTRABLE_ROLE_AUTHORIZATIONS`
...
--
-- Estrutura stand-in para view `COLUMNS_EXTENSIONS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `COLUMN_STATISTICS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_CACHED_INDEXES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_COLUMNS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_DATAFILES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FIELDS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FOREIGN`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_FOREIGN_COLS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_INDEXES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_SESSION_TEMP_TABLESPACES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_TABLES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_TABLESPACES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_TABLESPACES_BRIEF`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_TABLESTATS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `INNODB_TEMP_TABLE_INFO`
-- (Veja abaixo para a visão atual)
--
...
,`trx_requested_lock_id` varchar(126)
...
--
-- Estrutura stand-in para view `INNODB_VIRTUAL`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `RESOURCE_GROUPS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ROLE_COLUMN_GRANTS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ROLE_ROUTINE_GRANTS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ROLE_TABLE_GRANTS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `SCHEMATA_EXTENSIONS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ST_GEOMETRY_COLUMNS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ST_SPATIAL_REFERENCE_SYSTEMS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `ST_UNITS_OF_MEASURE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TABLESPACES_EXTENSIONS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TABLES_EXTENSIONS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `TABLE_CONSTRAINTS_EXTENSIONS`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `USER_ATTRIBUTES`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `VIEW_ROUTINE_USAGE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura stand-in para view `VIEW_TABLE_USAGE`
-- (Veja abaixo para a visão atual)
--
...
--
-- Estrutura para view `ADMINISTRABLE_ROLE_AUTHORIZATIONS`
--
...
--
-- Estrutura para view `COLUMNS_EXTENSIONS`
--
...
--
-- Estrutura para view `COLUMN_STATISTICS`
--
...
-- Erro ao ler a estrutura para a tabela information_schema.FILES: #1227 - Acesso negado. Você precisa o privilégio PROCESS para essa operação
...
--
-- Estrutura para view `INNODB_CACHED_INDEXES`
--
...
--
-- Estrutura para view `INNODB_COLUMNS`
--
...
--
-- Estrutura para view `INNODB_DATAFILES`
--
...
--
-- Estrutura para view `INNODB_FIELDS`
--
...
--
-- Estrutura para view `INNODB_FOREIGN`
--
...
--
-- Estrutura para view `INNODB_FOREIGN_COLS`
--
...
--
-- Estrutura para view `INNODB_INDEXES`
--
...
--
-- Estrutura para view `INNODB_SESSION_TEMP_TABLESPACES`
--
...
--
-- Estrutura para view `INNODB_TABLES`
--
...
--
-- Estrutura para view `INNODB_TABLESPACES`
--
...
--
-- Estrutura para view `INNODB_TABLESPACES_BRIEF`
--
...
--
-- Estrutura para view `INNODB_TABLESTATS`
--
...
--
-- Estrutura para view `INNODB_TEMP_TABLE_INFO`
--
...
--
-- Estrutura para view `INNODB_VIRTUAL`
--
...
--
-- Estrutura para view `RESOURCE_GROUPS`
--
...
--
-- Estrutura para view `ROLE_COLUMN_GRANTS`
--
...
--
-- Estrutura para view `ROLE_ROUTINE_GRANTS`
--
...
--
-- Estrutura para view `ROLE_TABLE_GRANTS`
--
...
--
-- Estrutura para view `SCHEMATA_EXTENSIONS`
--
...
--
-- Estrutura para view `ST_GEOMETRY_COLUMNS`
--
...
--
-- Estrutura para view `ST_SPATIAL_REFERENCE_SYSTEMS`
--
...
--
-- Estrutura para view `ST_UNITS_OF_MEASURE`
--
...
--
-- Estrutura para view `TABLESPACES_EXTENSIONS`
--
...
--
-- Estrutura para view `TABLES_EXTENSIONS`
--
...
--
-- Estrutura para view `TABLE_CONSTRAINTS_EXTENSIONS`
--
...
--
-- Estrutura para view `USER_ATTRIBUTES`
--
...
--
-- Estrutura para view `VIEW_ROUTINE_USAGE`
--
...
--
-- Estrutura para view `VIEW_TABLE_USAGE`
--
