...
<head>
   ...
   <!-- Google Tag Manager -->
    ...
    <title>Hidrante contra Incêndio - Brasil Segurança</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Hidrante contra Incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Hidrante contra Incêndio em SP é aqui!">
...
<div class="row" style="margin: 0px auto; ">
            ...
            <div class="col-lg-12 hgroupinternas" style="padding-top:20px; padding-bottom:10px;">
                ...
                <div class="container ">
						...
						<h1>Hidrante contra Incêndio</h1>
	...
	<div class="row" style="margin: 0px auto; ">
        ...
        <div class="col-lg-12">img-fluid
            ...
            <div class="container ">
				...
				<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="equipamentos-contra-incendio.php">Equipamentos Contra Incêndio</a></li><li class="active">Hidrante contra Incêndio</li></ol>
					...
					<h2>Hidrante de Combate a Incêndio</h2>img-fluid
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align:center; padding:0px;">
					...
					<img class="img-responsive"  src="images/hidrante-contra-incendio.jpg" alt="Hidrante de Combate a Incêndio" title="Hidrante de Combate a Incêndio" style="margin:0px auto;">
