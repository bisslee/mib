...
<head>
   ...
   <!-- Google Tag Manager -->
    ...
    <title>Placas de Sinalização de Incêndio - Brasil Segurança</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Placas de Sinalização de Incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Placas de Sinalização de Incêndio em SP é aqui!">
            ...
            <div class="col-lg-12 hgroupinternas" style="padding-top:20px; padding-bottom:10px;">
                ...
                <div class="container ">
					...
					img-fluid
						...
						<h1>Placas de Sinalização</h1>

						</div>

						

						<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12" style="padding:img-fluid0px;">
	...
	<div class="row" style="margin: 0px auto; ">
        ...
        <div class="col-lg-12">
            ...
            <div class="container ">
				...
				<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="produtos-e-acessorios-contra-incendio.php">Produtos e Acessórios</a></li><li class="active">Placas de Sinalização</li></ol>
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:4px; text-align:center;">
						...
						<div class="thumbnail" style="background:#ff8000; border-bottomimg-fluid0;  ">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="placa-de-sinalizacao-de-combate-a-incendio.php"  style="color:#fff; margin:0px;">Sinalização de Combate a Incêndio</a></h2>
						  ...
						  <div class="caption">
							...
							<p style="text-align:center;"><a href="placa-de-sinalizacao-de-combate-a-incendio.php" class="btn btn-primary" role="button">Ver Placas</a></p>
...
img-fluid
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:4px; text-align:center;">
						...
						<div class="thumbnail" style="background:#ff8000; border-bottom:solid 3px #000;">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="placa-de-sinalizacao-de-emergencia.php"  style="color:#fff; margin:0px;">Sinalização de Emergência - Orientação</a></h2>
						  ...
						  <a href="placa-de-sinalizacao-de-emergencia.php"><img class="img-reimg-fluid="images/placa-de-sinalizacao-de-emergencia.jpg" alt="Sinalização de Emergência - Orientação" title="Sinalização de Emergência - Orientação" style="border:solid 5px #fff; text-align:center;"></a>

						  <div class="caption">

							<p style="text-align:center;"><a href="placa-de-sinalizacao-de-emergencia.php" class="btn btn-primary" role="button">Ver Placas</a></p>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:4px; text-align:center;">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="placa-de-sinalizacoes-complementares.php"  style="color:#fff; margin:0px;">Sinalizações Complementares</a></h2>
						  ...
						  <div class="caption">
							...
							<p style="text-align:center;"><a href="placa-de-sinalizacoes-complementares.php" class="btn btn-primary" role="button">Ver Placas</a></p>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:4px; text-align:center;">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="placa-de-sinalizacao-de-proibicao.php"  style="color:#fff; margin:0px;">Sinalização de Proibição</a></h2>
						  ...
						  <div class="caption">
							...
							<p style="text-align:center;"><a href="placa-de-sinalizacao-de-proibicao.php" class="btn btn-primary" role="button">Ver Placas</a></p>
