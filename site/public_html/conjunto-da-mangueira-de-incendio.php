...
<head>
    ...
    <title>Conjunto da Mangueira de Incêndio - Brasil Segurança</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Conjunto da Mangueira de Incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Conjunto da Mangueira de Incêndio em SP é aqui!">
        ...
        <div class="col-lg-12">
            <div class="container ">
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<img class="img-responsive" src="images/conjunto-da-mangueira-de-incendio.jpg" alt="Conjunto da Mangueira de Incêndio" title="Conjunto da Mangueira de Incêndio" style="margin:0px auto;">
					</div>
