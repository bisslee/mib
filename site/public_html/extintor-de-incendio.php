...
<head>
    ...
    <!-- Google Tag Manager -->
        ...
        <meta name="description" content="Guia completo sobre extintores de incêndio, tipos, aplicações e especificações. Escolha o modelo ideal para sua segurança.">
  ...
  <title>Extintor de Incêndio - Guia Completo sobre Tipos e Aplicações</title>
...
<body>
   ...
   <a hre/api.whatsapp.com/send?phone=5511940258669" target="_blank"> <img src="imagesogo.png" width="200" alt=""></a>
...
.tira-whats{
	...
	<section class="container">
		...
		<div class="row">	
            ...
            <img src="images/planilha-2013.png" class="img-responsive" alt="">
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">O </span><strong><span>extintor de incêndio</span></strong><span style="'"> é um equipamento indispensável para a prevenção e combate a incêndios em ambientes residenciais, comerciais e industriais. Escolher o modelo correto pode ser decisivo para evitar a propagação do fogo e minimizar danos.</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Este guia apresenta todas as informações necessárias para entender os tipos de </span><strong><span>extintores de incêndio</span></strong><span style="'">, suas aplicações, especificações técnicas e regulamentações vigentes.</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Os </span><strong><span>extintores de incêndio</span></strong><span style="'"> são classificados conforme o agente extintor utilizado e o tipo de fogo que combatem, seguindo a norma </span><strong><span>ABNT NBR 12962</span></strong><span style="'">.</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt; font-size:13.5pt">
				...
				<strotyle="'; ">Incêndios Classe B – Líquidos inflamáveis (álcool, gasolina, óleos, tventes).</span></strong>
			...
			<ul type="disc" style="margin:0pt; padding-left:0pt">
				...
				<li style="margin-left:27.6pt; margin-bottom:14pt; padding-left:8.4pt; font-family:serif; font-size:10pt">
					...
					<strstyle="font-size:12pt;">Extintor de Pó Químico BC:</span></strong><span style=" font-size:12pterrompendo a reação química da combustão.</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Cada </span><strong><span>extintor de incêndio</span></strong><span style="'"> possui características técnicas que determinam seu desempenho e aplicabilidade.</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">A capacidade do </span><strong><span>extintor de incêndio</span></strong><span style="'"> é medida em litros (para líquidos) ou em quilogramas (para pós e gases).</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Os </span><strong><span>extintores de incêndio</span></strong><span style="'"> operam sob diferentes níveis de pressão, conforme o tipo de agente extintor:</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">A duração da descarga varia entre </span><strong><span>10 a 30 segundos</span></strong><span style="'">, dependendo do modelo.</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Os </span><strong><span>extintores de incêndio</span></strong><span style="'"> devem ser armazenados e utilizados dentro de faixas de temperatura recomendadas para garantir seu desempenho:</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Os cilindros dos </span><strong><span>extintores de incêndio</span></strong><span style="'"> são fabricados em aço-carbono, aço inoxidável ou alumínio, conforme o tipo de agente extintor armazenado.</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Os </span><strong><span>extintores de incêndio</span></strong><span style="'"> no Brasil devem atender às seguintes normas:</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">Para selecionar o melhor </span><strong><span>extintor de incêndio</span></strong><span style="'">, considere os seguintes fatores:</span>
			...
			<p style="margin-top:14pt; margin-bottom:14pt">
				...
				<span style="'">O </span><strong><span>extintor de incêndio</span></strong><span style="'"> é um equipamento essencial para a segurança de qualquer ambiente, garantindo controle rápido e eficaz de incêndios em seus estágios iniciais. Para que sua funcionalidade seja assegurada, é fundamental escolher o modelo correto, considerando o tipo de fogo a ser combatido e as exigências das normas de segurança.</span>
