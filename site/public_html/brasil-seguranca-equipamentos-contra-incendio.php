...
<head>
   ...
   <!-- Google Tag Manager -->
    ...
    <title>Brasil Segurança - Equipamentos Contra Incêndio</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Somos especializados em equipamentos contra incêndio. Mangueiras de Incêndio, Extintores de Incêndio e muito mais, confira!">
...
<div class="row" style="margin: 0px auto; ">
	...
	<div class="row" style="margin: 0px auto; ">
        <div class="col-lg-12">
            <div class="container ">
				<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li class="active">Brasil Segurança</li></ol>
...
<p>Brasil segurança.</p>
				...
				<img class="img-responsive"  src="images/brasil-seguranca-equipamentos-contra-incendio.jpg" style="margin:0px auto;" alt="Brasil Segurança - Equipamentos Contra Incêndio" title="Brasil Segurança - Equipamentos Contra Incêndio" >
