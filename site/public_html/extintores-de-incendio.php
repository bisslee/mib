...
<head>
    ...
    <title>Extintores de incêndio - Brasil Segurança</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Extintores de incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Extintores de incêndio em SP é aqui!">
...
<div class="row" style="margin: 0px auto; ">
	...
	<div class="row" style="margin: 0px auto; ">
        <div class="col-lg-12">
            <div class="container ">
				<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="equipamentos-contra-incendio.php">Equipamentos Contra Incêndio</a></li><li class="active">Extintores de incêndio</li></ol>
				
				
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h2>Extintores de incêndio</h2>
					</div>
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<img class="img-responsive"  src="images/extintores-de-incendio.jpg" class="img-responsive" alt="Extintores de incêndio" title="Extintores de incêndio" style="margin:0px auto;">
					</div>
				...
				<p><strong>Confira nossos extintores de incêndio:</strong> </p>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:4px; text-align:center;">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="extintor-de-incendio-portatil.php"  style="color:#fff; margin:0px;">Extintor de Incêndio Portátil</a></h2>
						  <a href="extintor-de-incendio-portatil.php"><img class="img-responsive"  src="images/extintor-de-incendio-portatil.jpg" alt="Extintor de Incêndio Portátil" title="Extintor de Incêndio Portátil" style="text-align:center;"></a>
						  <div class="caption">
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:4px; text-align:center;">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="extintor-de-incendio-sobre-rodas.php"  style="color:#fff; margin:0px;">Extintor de Incêndio Sobre Rodas</a></h2>
						  <a href="extintor-de-incendio-sobre-rodas.php"><img class="img-responsive"  src="images/extintor-de-incendio-sobre-rodas.jpg" alt="Extintor de Incêndio Sobre Rodas" title="Extintor de Incêndio Sobre Rodas" style="text-align:center;"></a>
						  <div class="caption">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="extintor-de-incendio-co2.php"  style="color:#fff; margin:0px;">Extintor de Incêndio CO2</a></h2>
						  <a href="extintor-de-incendio-co2.php"><img class="img-responsive"  src="images/extintor-de-incendio-co2.jpg" alt="Extintor de Incêndio CO2" title="Extintor de Incêndio CO2" style="text-align:center;"></a>
						  <div class="caption">
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:4px; text-align:center;">
						...
						<h2 style="margin:10px; font-size:17px; padding-bottom:10px; font-weight:bold;"><a href="extintor-de-incendio-para-predio.php"  style="color:#fff; margin:0px;">Extintor de Incêndio para Prédio</a></h2>
						  <a href="extintor-de-incendio-para-predio.php"><img class="img-responsive"  src="images/extintor-de-incendio-para-predio.jpg" alt="Extintor de Incêndio para Prédio" title="Extintor de Incêndio para Prédio" style="border:solid 5px #fff; text-align:center;"></a>
						  <div class="caption">
                ...
                <p>A escolha da empresa fornecedora para realizar a <strong>compra de extintores de incêndio</strong> é também uma tarefa importante, afinal é ela que irá garantir a qualidade e eficiência dos equipamentos e produto, pois não se brinca com fogo, isso é assunto sério que deve ser tratado com importância.  Portanto, entre em contato com a Brasil Segurança para realizar a <strong>compra de extintores de incêndio</strong>, uma empresa seria e que comercializa produtos da maior qualidade.</p>
                
                <p>A <strong>Brasil Segurança atende todo o Brasil</strong>, a empresa é uma das líderes quando o assunto é <strong>equipamento contra incêndio</strong>. Na hora da <strong>compra de extintores de incêndio</strong> escolha a Brasil Segurança e leve um produto de qualidade e garantia, pois a empresa só comercializa equipamentos de primeira para satisfazer e garantir maior segurança para seu clientes. </p>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding:4px; text-align:center;" >
						<div class="thumbnail" style="background:#333; border-bottom:solid 3px #000; min-height:230px;  ">
						  ...
						  <a href="esguichos-para-equipamentos-contra-incendio.php"><img class="img-responsive"  src="images/esguichos-para-equipamentos-contra-incendio.jpg" alt="Esguichos" title="Esguichos" style="border:solid 5px #fff; text-align:center;"></a>
						  <div class="caption">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding:4px; text-align:center;" >
						<div class="thumbnail" style="background:#333; border-bottom:solid 3px #000; min-height:230px;  ">
						  ...
						  <a href="hidrante-contra-incendio.php"><img class="img-responsive"  src="images/hidrante-contra-incendio.jpg" alt="Hidrante contra Incêndio" title="Hidrante contra Incêndio" style="border:solid 5px #fff; text-align:center;"></a>
						  <div class="caption">
							<h2 style="margin-top:0px; font-size:14px; font-weight:bold;"><a href="hidrante-contra-incendio.php" style="color:#fff;">Hidrante</a></h2>
							<p style="text-align:center;"><a href="hidrante-contra-incendio.php" style="font-size:10px;" class="btn btn-default" role="button">SAIBA MAIS</a></p>
						  </div>
						</div>
					</div>
					</div>
