...
<head>
   ...
   <!-- Google Tag Manager -->
	...
	<title>Sistema aerossol de supressão a incêndio - Brasil Segurança</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Sistema aerossol de supressão a incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Sistema aerossol de supressão a incêndio em SP é aqui!">
...
<div class="row" style="margin: 0px auto; ">
            ...
            <div class="col-lg-12 hgroupinternas" style="padding-top:20px; padding-bottom:10px;">
                ...
                <div class="container ">
						...
						<h1>Sistema aerossol de supressão a incêndio</h1>
						...
						<p style="text-align:right;"><a href="contato.php" img-fluid-info" role="button">Solicite um orçamento!</a></p>
	...
	<div class="row" style="margin: 0px auto; ">
        ...
        <div class="col-lg-12">
            ...
            <div class="container ">
				...
				<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="equipamentos-contra-incendio.php">Equipamentos Contra Incêndio</a></li><li class="active">Sistema aerossol de supressão a incêndio</li></ol>
img-fluid
					...
					<h2>Sistema aerossol de supressão a incêndio</h2>
...
img-fluid
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<img class="img-responsive"  src="images/sistema-aerossol-de-supressao-a-incendio.jpg" class="img-responsive" alt="Sistema aerossol de supressão a incêndio" title="Sistema aerossol de supressão a incêndio" style="margin:0px auto;">
