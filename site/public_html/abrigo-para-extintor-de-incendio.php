	...
	<head>
	    ...
	    <title>Abrigo para Extintor de Incêndio - Brasil Segurança</title>

	    <meta http-equiv="X-UA-Compatible" content="IE=edge">

	    <meta name="viewport" content="width=device-width, initial-scale=1">

	    <meta name="description" content="Abrigo para Extintor de Incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Abrigo para Extintor de Incêndio em SP é aqui!">
...
img-fluid
	...
	<body>
        ...
        height="0" width="0" style="display:none;visibilimg-fluidiframe></noscript>
	...
	<div class="row" style="margin: 0px auto; ">
	            ...
	            <div class="col-lg-12 hgroupinternas" style="padding-topimg-fluid-bottom:10px;">
	                ...
	                <div class="container ">
							...
							<h1>Abrigo para Extintor de Incêndio</h1>
		...
		<div class="row" style="margin: 0px auto; ">
	        ...
	        <div class="col-lg-12">
	            ...
	            <div class="container ">
					...
					<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="produtos-e-acessorios-contra-incendio.php">Produtos e Acessórios</a></li><li><a href="abrigos-para-equipamentos-contra-incendio.php">Abrigos</a></li><li class="active">Abrigo para Extintor de Incêndio</li></ol>
						...
						<h2>Abrigo para Extintor de Incêndio</h2>
					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
						...
						<img class="img-responsive"  src="images/abrigo-para-extintor-de-incendio.jpg" alt="Abrigo para Extintor de Incêndio" title="Abrigo para Extintor de Incêndio" style="margin:0px auto;">

						</div>

						

						<p>Os abrigos para extintor tem a finalidade de preservar o extintor de incêndio, sua fabricação tem que ser de boa qualidade para durar o maior tempo possível.</p>
