...
<head>
   ...
   <!-- Google Tag Manager -->
    ...
    <title>Líquido Gerador de Espuma - Brasil Segurança</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Líquido Gerador de Espuma é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Líquido Gerador de Espuma em SP é aqui!">
...
<div class="row" style="margin: 0px auto; ">
            ...
            <div class="col-lg-12 hgroupinternas" style="padding-top:20px; padding-bottom:10px;">
                ...
                <div class="container ">
						...
						<h1>Líquido Gerador de Espuma</h1>img-fluid
	...
	<div class="row" style="margin: 0px auto; ">
        ...
        <div class="col-lg-12">
            ...
            <div class="container ">
				...
				<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="produtos-e-acessorios-contra-incendio.php">Produtos e Acessórios</a></li><li class="active">Líquido Gerador de Espuma</li></ol>
				...
				img-fluid
					...
					<h2>Líquido Gerador de Espuma - LGE</h2>
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<img class="img-responsive" src="images/liquido-gerador-de-espuma.jpg" alt="Líquido Gerador de Espuma" title="Líquido Gerador de Espuma" style="margin:0px auto;">
