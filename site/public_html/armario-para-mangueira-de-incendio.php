...
<head>
   ...
   <!-- Google Tag Manager -->
    ...
    <title>Armário para Mangueira de Incêndio - Brasil Segurança</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Armário para Mangueira de Incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Armário para Mangueira de Incêndio em SP é aqui!">
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
  ...
  ga('create', 'UA-43431644-1', 'mangueirasdeincendiobrasil.com.br');
...
<div class="row" style="margin: 0px auto; ">
            ...
            <div class="col-lg-12 hgroupinternas" style="padding-top:20px; padding-bottom:10px;">
                ...
                <div class="container ">
						...
						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12" style="padding:20px img-fluid>

						<h1>Armário para Mangueira de Incêndio</h1>
	...
	<div class="row" style="margin: 0px auto; ">
        ...
        <div class="col-lg-12">
            ...
            <div class="container ">
				...
				<ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="produtos-e-acessorios-contra-incendio.php">Produtos e Acessórios</a></li><li class="active">Armário para Mangueira de Incêndio</li></ol>
					...
					<h2>Armário para Mangueira de Incêndio</h2>
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<img class="img-responsive" src="images/armario-para-mangueira-de-incendio.jpg" alt="Armário para Mangueira de Incêndio" title="Armário para Mangueira de Incêndio" style="margin:0px auto;">
