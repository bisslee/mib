...
<head>
    ...
    <title>Material de Combate a Incêndio - Brasil Segurança</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Material de Combate a Incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Material de Combate a Incêndio em SP é aqui!">
            ...
            <div class="col-lg-12 hgroupinternas" style="padding-top:20px; padding-bottom:10px;">
                ...
                <div class="container ">
					...
					img-fluid
						...
						<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12" simg-fluid20px 0px 20px 0px;">
