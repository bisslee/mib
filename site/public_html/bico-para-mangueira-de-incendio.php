...
<head>
   ...
   <!-- Google Tag Manager -->
    ...
    <title>Bico para Mangueira de Incêndio - Brasil Segurança</title>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Bico para Mangueira de Incêndio é na Brasil Segurança. Contamos com diversos equipamentos contra incêndio. Bico para Mangueira de Incêndio em SP é aqui!">
...
img-fluid
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<img class="img-responsive" src="images/bico-para-mangueira-de-incendio.jpg" alt="Bico para Mangueira de Incêndio" title="Bico para Mangueira de Incêndio" style="margin:0px auto;">
