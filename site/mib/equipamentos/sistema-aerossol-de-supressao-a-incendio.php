...
$page_config = array(
    'title' => 'Sistema Aerossol de Supressão a Incêndio Certificado ABNT - MIB | Mangueiras de Incêndio Brasil',
    'description' => 'Sistema aerossol de supressão a incêndio certificado ABNT. Sistema moderno e eficiente para supressão de incêndios sem afetar a camada de ozônio. MIB São Paulo.',
    'keywords' => 'Sistema Aerossol São Paulo, Supressão Incêndio SP, Equipamentos Contra Incêndio, MIB, aerossol certificado ABNT, sistema moderno incêndio, supressão fogo',
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/equipamentos/sistema-aerossol-de-supressao-a-incendio.php',
);
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding:4px; text-align:center;">
                                                            ...
                                                            <div class="thumbnail" style="background:#333; border-bottom:solid 3px #000; min-height:230px; ">
                                                                ...
                                                                <div class="caption">
                                                                    ...
                                                                    <h2 style="margin-top:0px; font-size:14px; font-weight:bold;"><a href="/old-pages/derivante-para-mangueira-de-incendio.php" style="color:#fff;">Derivante</a></h2>

                                                                    <p style="text-align:center;"><a href="/old-pages/derivante-para-mangueira-de-incendio.php" style="font-size:10px;" class="btn btn-default" role="button">SAIBA MAIS</a></p>
