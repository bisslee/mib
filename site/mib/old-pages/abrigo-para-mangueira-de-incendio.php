 ...
 * Arquivo original: abrigo-para-mangueira-de-incendio.php
 */

// Configuração da página
$page_config = array(
    'title' => 'Abrigo para Mangueira de Incêndio - MIB | Mangueiras de Incêndio Brasil',
    'description' => 'Solicite um orçamento!',
    'keywords' => 'mangueiras de incêndio, equipamentos contra incêndio, segurança contra incêndio, extintores, hidrantes',
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/old-pages/abrigo-para-mangueira-de-incendio.php',
);
...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Abrigo para Mangueira de Incêndio',
    ),
);

$heroConfig = array(
    'title' => 'Abrigo para Mangueira de Incêndio',
    'description' => 'Solicite um orçamento!',
...
<div class="row" style="margin: 0px auto; ">
 ...
 <h1>Abrigo para Mangueira de Incêndio</h1>
 ...
 <ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="produtos-e-acessorios-contra-incendio.php">Produtos e Acessórios</a></li><li><a href="abrigos-para-equipamentos-contra-incendio.php">Abrigos</a></li><li class="active">Abrigo para Mangueira de Incêndio</li></ol>

 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

 <h2>Abrigo para Mangueira de Incêndio</h2>
 ...
 <img class="img-fluid" src="/assets/img/old-site/abrigo-para-mangueira-de-incendio.jpg" alt="Abrigo para Mangueira de Incêndio" title="Abrigo para Mangueira de Incêndio" style="margin:0px auto;">

 </div>

 <p>Os abrigos para mangueira de incêndio servem para preservar a mangueira de incêndio, temos vários tipos de abrigos para mangueira: abrigo industriais, abrigos de embutir e abrigos externos.</p>
