 ...
 * Arquivo original: placa-de-sinalizacao-de-combate-a-incendio.php
 */

// Configuração da página
$page_config = array(
    'title' => 'Placas de Sinalização de Combate a Incêndio - MIB | Mangueiras de Incêndio Brasil',
    'description' => 'Solicite um orçamento!',
    'keywords' => 'mangueiras de incêndio, equipamentos contra incêndio, segurança contra incêndio, extintores, hidrantes',
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/old-pages/placa-de-sinalizacao-de-combate-a-incendio.php',
);
...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Placas de Sinalização de Combate a Incêndio',
    ),
);

$heroConfig = array(
    'title' => 'Placas de Sinalização de Combate a Incêndio',
    'description' => 'Solicite um orçamento!',
...
<div class="row" style="margin: 0px auto; ">
 ...
 <img class="img-responsive" src="/assets/img/old-site/placas-de-sinalizacao-de-combate-a-incendio.jpg" alt="Placas de Sinalização de Combate a Incêndio" title="Placas de Sinalização de Combate a Incêndio" style="margin:0px auto; text-align:center;"></a>
