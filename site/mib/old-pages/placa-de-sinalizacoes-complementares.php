 ...
 * Arquivo original: placa-de-sinalizacoes-complementares.php
 */

// Configuração da página
$page_config = array(
    'title' => 'Placas de Sinalizações Complementares - MIB | Mangueiras de Incêndio Brasil',
    'description' => 'Solicite um orçamento!',
    'keywords' => 'mangueiras de incêndio, equipamentos contra incêndio, segurança contra incêndio, extintores, hidrantes',
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/old-pages/placa-de-sinalizacoes-complementares.php',
);
...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Placas de Sinalizações Complementares',
    ),
);

$heroConfig = array(
    'title' => 'Placas de Sinalizações Complementares',
    'description' => 'Solicite um orçamento!',
...
<div class="row" style="margin: 0px auto; ">
 ...
 <img class="img-responsive" src="/assets/img/old-site/placas-de-sinalizacoes-complementares.jpg" alt="Placas de Sinalizações Complementares" title="Placas de Sinalizações Complementares" style="margin:0px auto; text-align:center;"></a>
