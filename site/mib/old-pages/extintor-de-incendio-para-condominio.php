 ...
 * Arquivo original: extintor-de-incendio-para-condominio.php
 */

// Configuração da página
$page_config = array(
    'title' => 'Extintor de Incêndio para Condomínio - MIB | Mangueiras de Incêndio Brasil',
    'description' => 'Solicite um orçamento!',
    'keywords' => 'mangueiras de incêndio, equipamentos contra incêndio, segurança contra incêndio, extintores, hidrantes',
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/old-pages/extintor-de-incendio-para-condominio.php',
);
...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Extintor de Incêndio para Condomínio',
    ),
);

$heroConfig = array(
    'title' => 'Extintor de Incêndio para Condomínio',
    'description' => 'Solicite um orçamento!',
...
<div class="row" style="margin: 0px auto; ">
 ...
 <img class="img-responsive" src="/assets/img/old-site/extintor-de-incendio-para-condominio.jpg" alt="Extintor de Incêndio para Condomínio" title="Extintor de Incêndio para Condomínio" style="text-align:center;">
