 ...
 * Arquivo original: placa-de-sinalizacao-de-proibicao.php
 */

// Configuração da página
$page_config = array(
    'title' => 'Placas de Sinalização de Proibição - MIB | Mangueiras de Incêndio Brasil',
    'description' => 'Solicite um orçamento!',
    'keywords' => 'mangueiras de incêndio, equipamentos contra incêndio, segurança contra incêndio, extintores, hidrantes',
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/old-pages/placa-de-sinalizacao-de-proibicao.php',
);
...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Placas de Sinalização de Proibição',
    ),
);

$heroConfig = array(
    'title' => 'Placas de Sinalização de Proibição',
    'description' => 'Solicite um orçamento!',
...
<div class="row" style="margin: 0px auto; ">
 ...
 <img class="img-responsive" src="/assets/img/old-site/placas-de-sinalizacao-de-proibicao.jpg" alt="Sinalização de Proibição" title="Sinalização de Proibição" style="margin:0px auto; text-align:center;"></a>
