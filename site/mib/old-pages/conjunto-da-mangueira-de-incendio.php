 ...
 * Arquivo original: conjunto-da-mangueira-de-incendio.php
 */
...
$page_config = array(
    ...
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/old-pages/conjunto-da-mangueira-de-incendio.php',
);
...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Conjunto da Mangueira de Incêndio',
    ),
);

$heroConfig = array(
    'title' => 'Conjunto da Mangueira de Incêndio',
    'description' => 'Solicite um orçamento!',
...
<div class="row" style="margin: 0px auto; ">
 ...
 <h1>Conjunto da Mangueira de Incêndio</h1>
 ...
 <ol class="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="produtos-e-acessorios-contra-incendio.php">Produtos e Acessórios</a></li><li class="active">Conjunto da Mangueira de Incêndio</li></ol>

 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

 <h2>Conjunto da Mangueira de Incêndio</h2>
 ...
 <img class="img-fluid" src="/assets/img/old-site/conjunto-da-mangueira-de-incendio.jpg" alt="Conjunto da Mangueira de Incêndio" title="Conjunto da Mangueira de Incêndio" style="margin:0px auto;">
