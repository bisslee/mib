 ...
 * Arquivo original: valvula-globo-angular-para-hidrante.php
 */

// Configuração da página
$page_config = array(
    'title' => 'Válvula Globo Angular para Hidrante - MIB | Mangueiras de Incêndio Brasil',
    'description' => 'Solicite um orçamento!',
    'keywords' => 'mangueiras de incêndio, equipamentos contra incêndio, segurança contra incêndio, extintores, hidrantes',
    'canonical' => 'https://mangueirasdeincendiobrasil.com.br/old-pages/valvula-globo-angular-para-hidrante.php',
);
...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Válvula Globo Angular para Hidrante',
    ),
);

$heroConfig = array(
    'title' => 'Válvula Globo Angular para Hidrante',
    'description' => 'Solicite um orçamento!',
...
<div class="row" style="margin: 0px auto; ">
 ...
 <img class="img-responsive" src="/assets/img/old-site/valvula-globo-angular-para-hidrante.jpg" alt="Válvula Globo Angular para Hidrante" title="Válvula Globo Angular para Hidrante" style="margin:0px auto;">
