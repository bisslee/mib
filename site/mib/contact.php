            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="social-icons text-center">
                        <a href="https://www.tiktok.com/@mangueirasincendio2025" target="_blank" class="social-icon me-4" title="TikTok">
                            <i class="fab fa-tiktok fa-3x text-danger"></i>
                        </a>
                        <a href="https://www.instagram.com/mangueirasdeincendiobrasil/" target="_blank" class="social-icon me-4" title="Instagram">
                            <i class="fab fa-instagram fa-3x text-danger"></i>
                        </a>
                        <a href="https://www.linkedin.com/company/mangueirasdeincendiobrasil/" target="_blank" class="social-icon me-4" title="LinkedIn">
                            <i class="fab fa-linkedin fa-3x text-primary"></i>
                        </a>
                        <a href="https://www.youtube.com/@MangueirasDeIncendioBrasil" target="_blank" class="social-icon me-4" title="YouTube">
                            <i class="fab fa-youtube fa-3x text-danger"></i>
                        </a>
                        <a href="https://wa.me/5511940258669?text=Vim pelo site e gostaria de mais informações sobre seus produtos." target="_blank" class="social-icon" title="WhatsApp">
                            <i class="fab fa-whatsapp fa-3x text-success"></i>
                        </a>
                    </div>
                </div>
