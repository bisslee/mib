...
if (file_exists(__DIR__ . '/' . $data_file)) {
    ...
    if (function_exists('getPageConfig')) {
        ...
        $page_config = [
            'title' => 'Validade da Mangueira de Incêndio – MIB',
            'description' => 'Validade da mangueira de incêndio',
            'keywords' => 'validade mangueira incêndio',
        ...
        $HeroSection = [
            ...
            'subtitle' => 'Prazo, troca e certificação'
        ];
