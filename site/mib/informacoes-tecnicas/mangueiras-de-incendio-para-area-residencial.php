...
if (file_exists(__DIR__ . '/' . $data_file)) {
    ...
    if (function_exists('getPageConfig')) {
        ...
        $page_config = [
            'title' => 'Mangueiras de Incêndio para Área Residencial – MIB',
            'description' => 'Mangueiras de incêndio para área residencial',
            'keywords' => 'mangueiras incêndio residencial',
            'canonical' => 'https://mangueirasdeincendiobrasil.com.br/informacoes-tecnicas/mangueiras-de-incendio-para-area-residencial.php'
        ];
        $current_page = 'Mangueiras de Incêndio para Área Residencial';
        $breadcrumbs = [
            ['text' => 'Home', 'url' => '/'],
        ...
        $HeroSection = [
            ...
            'subtitle' => 'Tipo 1 certificadas para condomínios'
        ];
