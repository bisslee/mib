        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="page-title">Informações Técnicas</h1>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <p class="lead">
                                    💡 A MIB é especialista em atender condomínios, indústrias, comércios, hospitais, galpões e transportadoras com equipamentos contra incêndio certificados. ⚠️ Não saia do site sem solicitar seu orçamento: iluminação de emergência é item obrigatório e salva vidas em evacuações.
                                </p>
                            </div>
                        </div>
