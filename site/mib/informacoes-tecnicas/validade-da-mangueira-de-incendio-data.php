<?php
// Data COMPLETA para: validade-da-mangueira-de-incendio.php
// TODAS AS 11 SEÇÕES EXTRAÍDAS DO ARQUIVO ORIGINAL
...
$page_data = [
    'page_config' => [
        ...
        'keywords' => 'Validade da mangueira de incêndio, vida útil, ensaios obrigatórios ABNT NBR 12779, selo Inmetro, troca preventiva, riscos com mangueiras antigas',
        'canonical' => 'https://mangueirasdeincendiobrasil.com.br/informacoes-tecnicas/validade-da-mangueira-de-incendio.php'
    ],
    'current_page' => 'Validade da Mangueira de Incêndio',
    'breadcrumbs' => [
        ['text' => 'Home', 'url' => '/'],
    ...
    'heroSection' => [
        ...
        'subtitle' => 'Vida útil, ensaios obrigatórios ABNT NBR 12779, selo Inmetro e quando realizar a troca preventiva. Evite riscos com mangueiras antigas sem certificação.'
    ],
    'pageContent' => [
        'sections' => [
            // ============================================
            // SEÇÃO 1 - Introdução (5 itens)
            // ============================================
            [
                'order' => 1,
                'title' => '',
            ...
            // ============================================
            // SEÇÃO 2 - Alerta de segurança (6 itens)
            // ============================================
            [
                'order' => 2,
                ...
                'content-list' => [
                    ...
                    [
                        ...
                        'list-with-title' => [
                            ...
                            'list' => [
                                ['item' => '<b>Tipo 1 – Predyflex:</b> para condomínios residenciais e edifícios habitacionais.'],
            ...
            // ============================================
            // SEÇÃO 4 - Observação importante (2 itens)
            // ============================================
            [
                'order' => 4,
            ...
            // ============================================
            // SEÇÃO 5 - Vida útil e validade (1 item)
            // ============================================
            [
                'order' => 5,
            ...
            // ============================================
            // SEÇÃO 6 - Destaque importante (6 itens)
            // ============================================
            [
                'order' => 6,
            ...
            // ============================================
            // SEÇÃO 7 - Critérios para troca (2 itens)
            // ============================================
            [
                'order' => 7,
            ...
            // ============================================
            // SEÇÃO 8 - Tabela comparativa (1 item)
            // ============================================
            [
                'order' => 8,
            ...
            // ============================================
            // SEÇÃO 10 - FAQ (1 item com 6 perguntas)
            // ============================================
            [
                'order' => 10,
            ...
            // ============================================
            // SEÇÃO 11 - Micro-storytelling (5 itens)
            // ============================================
            [
                'order' => 11,
