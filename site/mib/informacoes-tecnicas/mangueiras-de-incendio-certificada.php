...
if (file_exists(__DIR__ . '/' . $data_file)) {
    ...
    if (function_exists('getPageConfig')) {
        ...
        $page_config = [
            'title' => 'Mangueiras de Incêndio Certificadas ABNT – MIB',
            'description' => 'Mangueiras de incêndio certificadas ABNT',
            'keywords' => 'mangueiras certificadas ABNT',
            'canonical' => 'https://mangueirasdeincendiobrasil.com.br/informacoes-tecnicas/mangueiras-de-incendio-certificada.php'
        ];
        $current_page = 'Mangueiras de Incêndio Certificadas ABNT';
        $breadcrumbs = [
            ['text' => 'Home', 'url' => '/'],
        ...
        $HeroSection = [
            ...
            'subtitle' => 'Produtos certificados com qualidade garantida'
        ];
