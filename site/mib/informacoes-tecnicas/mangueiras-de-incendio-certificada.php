...
$breadcrumbs = array(
    ...
    1 => array(
        'url' => '',
        'text' => 'Mangueiras de Incêndio Certificadas ABNT',
    ),
);
...
$HeroSection = [
    ...
    'subtitle' => 'Mangueiras de Incêndio Brasil. Modelos Tipo 1 a 5, comprimentos de 15 a 30 m, selo ABNT + INMETRO, resistência, durabilidade e segurança para <,>condomínios, indústrias, hospitais, galpões e comércios.</b>'
];
            ...
            'content-list' => [
                ...
                [
                    ...
                    'list' => [
                        ...
                        ['item' => '•	Revestimento interno: borracha sintética de alta resistência'],
                        ['item' => '•	Revestimento externo: tecido de poliéster trançado'],
                ...
                [
                    ...
                    'list' => [
                        ['item' => '•	Cor: Branca ⚪'],
                        ['item' => '•	Comprimentos: 15, 20, 25 e 30 metros'],
                        ['item' => '•	Diâmetros internos: 1 ½” (38 mm) e 2 ½” (65 mm)'],
                        ['item' => '•	Pressão de trabalho: 14 kgf/cm²'],
                        ['item' => '•	Pressão de ensaio hidrostático: 28 kgf/cm²'],
                        ['item' => '•	Pressão mínima de ruptura: +45 kgf/cm²'],
                        ['item' => '•	Revestimento interno: borracha sintética vulcanizada'],
                ...
                [
                    ...
                    'list' => [
                        ...
                        ['item' => '•	Pressão de ensaio hidrostático: 28 kgf/cm²'],
                        ['item' => '•	Pressão mínima de ruptura: +45 kgf/cm²'],
                        ['item' => '•	Revestimento interno: borracha sintética especial resistente a agentes químicos'],
                        ['item' => '•	Revestimento externo: tecido de poliéster trançado com proteção contra abrasão'],
                ...
                [
                    ...
                    'list' => [
                        ...
                        ['item' => '•	Diâmetros internos: 1 ½” (38 mm) e 2 ½” (65 mm)'],
                        ['item' => '•	Pressão de trabalho: 14 kgf/cm²'],
                        ['item' => '•	Pressão de ensaio hidrostático: 42 kgf/cm²'],
                        ['item' => '•	Pressão mínima de ruptura: +45 kgf/cm²'],
                        ['item' => '•	Revestimento interno: borracha nitrílica de alta durabilidade'],
                        ['item' => '•	Revestimento externo: borracha vulcanizada com reforço têxtil de poliéster'],
