...
if (file_exists(__DIR__ . '/' . $data_file)) {
    ...
    if (function_exists('getPageConfig')) {
        ...
        $page_config = [
            'title' => 'Mangueira de Incêndio para Condomínio – MIB',
            'description' => 'Mangueiras de incêndio para condomínios',
            'keywords' => 'mangueira incêndio condomínio',
            'canonical' => 'https://mangueirasdeincendiobrasil.com.br/informacoes-tecnicas/mangueira-de-incendio-para-condominio.php'
        ];
        $current_page = 'Mangueira de Incêndio para Condomínio';
        $breadcrumbs = [
            ['text' => 'Home', 'url' => '/'],
            ['text' => 'Informações Técnicas', 'url' => '/informacoes-tecnicas/'],
            ['text' => 'Mangueira de Incêndio para Condomínio', 'active' => true]
        ];
        $HeroSection = [
            'title' => 'Mangueira de Incêndio para Condomínio',
            'subtitle' => 'Segurança certificada para condomínios'
        ];
