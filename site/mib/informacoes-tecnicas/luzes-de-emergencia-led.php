...
if (file_exists(__DIR__ . '/' . $data_file)) {
    ...
    if (function_exists('getPageConfig')) {
        ...
        $page_config = [
            'title' => 'Luzes de Emergência LED – MIB | Mangueiras de Incêndio Brasil',
            'description' => 'Luzes de emergência LED certificadas',
            'keywords' => 'luzes de emergência, LED, equipamentos contra incêndio',
            'canonical' => 'https://mangueirasdeincendiobrasil.com.br/informacoes-tecnicas/luzes-de-emergencia-led.php'
        ];
        $current_page = 'Luzes de Emergência LED';
        $breadcrumbs = [
            ['text' => 'Home', 'url' => '/'],
            ['text' => 'Informações Técnicas', 'url' => '/informacoes-tecnicas/'],
            ['text' => 'Luzes de Emergência LED', 'active' => true]
        ];
        $HeroSection = [
            'title' => 'Luzes de Emergência LED',
            'subtitle' => 'Equipamentos certificados para segurança'
        ];
