<?php
// Data COMPLETA para: informacoes-tecnicas-mangueiras-incendio.php
// TODAS AS 4 SEÇÕES EXTRAÍDAS DO ARQUIVO ORIGINAL

$page_data = [
    'page_config' => [
        'title' => 'Informações Técnicas Mangueiras de Incêndio – ABNT NBR 11861 - MIB | Mangueiras de Incêndio Brasil',
        'description' => 'Informações Técnicas Mangueiras de Incêndio conforme ABNT NBR 11861. Tipos 1 a 5 em 15, 20, 25 e 30 m, certificados ABNT + Inmetro',
        'keywords' => 'ABNT NBR 11861, mangueiras incêndio, informações técnicas, tipos mangueira, certificação ABNT, Inmetro',
    ...
    'pageContent' => [
        'sections' => [
            // ============================================
            // SEÇÃO 1 - Introdução e Normas (5 itens)
            // ============================================
            [
                'order' => 1,
                'title' => '',
            ...
            // ============================================
            // SEÇÃO 2 - Modelos e Especificações (19 itens)
            // ============================================
            [
                'order' => 2,
