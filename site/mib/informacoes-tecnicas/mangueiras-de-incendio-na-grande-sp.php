...
if (file_exists(__DIR__ . '/' . $data_file)) {
    ...
    if (function_exists('getPageConfig')) {
        ...
        $page_config = [
            'title' => 'Mangueiras de Incêndio na Grande SP – MIB',
            'description' => 'Mangueiras de incêndio na Grande SP',
            'keywords' => 'mangueiras incêndio grande sp',
            'canonical' => 'https://mangueirasdeincendiobrasil.com.br/informacoes-tecnicas/mangueiras-de-incendio-na-grande-sp.php'
        ];
        $current_page = 'Mangueiras de Incêndio na Grande SP';
        $breadcrumbs = [
            ['text' => 'Home', 'url' => '/'],
        ...
        $HeroSection = [
            'title' => 'Mangueiras de Incêndio na Grande SP',
            'subtitle' => 'Certificadas ABNT NBR 11861'
        ];
