...
$breadcrumbs = [
    ...
    ['text' => 'Luz de Emergência LED', 'active' => true]
];
    ...
    'sections' => [
        [
            ...
            'content-list' =>[
                [
                    'order' => 1,
                    'image' => $site_config['base_url'] . '/assets/img/informacoes-tecnicas/luz-emergencia-led-18.webp',
                    'content' => '',
                    'list' => [],
                    'table' => [],
                ],
                [
                    'order' => 2,
                    'image' => '',
                    'content' => '💡 A MIB é especialista em atender condomínios, indústrias, comércios, hospitais, galpões e transportadoras com equipamentos contra incêndio certificados. <br>⚠️ Não saia do site sem solicitar seu orçamento: iluminação de emergência é item obrigatório e salva vidas em evacuações.',
                    'list' => [],
                    'table' => []
                ]
            ]
        ...
        [
            ...
            'content-list' => [
                [
                    'order' => 1,
                    'image' => $site_config['base_url'] . '/assets/img/informacoes-tecnicas/luz-emergencia-led-14.webp',
                    'content' => '',
                    'list' => [],
                    'table' => [],
                ],
        ...
        [
            ...
            'content-list' => [
                [
                    'order' => 1,
                    'image' => $site_config['base_url'] . '/assets/img/informacoes-tecnicas/luz-emergencia-led-15.webp',
                    'content' => '',
                    'list' => [],
                    'table' => [],
                ],
        ...
        [
            ...
            'content-list' => [
                [
                    'order' => 1,
                    'image' => $site_config['base_url'] . '/assets/img/informacoes-tecnicas/luz-emergencia-led-16.webp',
                    'content' => '',
                    'list' => [],
                    'table' => [],
                ],
        ...
        [
            ...
            'content-list' => [
                [
                    'order' => 1,
                    'image' => $site_config['base_url'] . '/assets/img/informacoes-tecnicas/luz-emergencia-led-17.webp',
                    'content' => '',
                    'list' => [],
                    'table' => [],
                ],
