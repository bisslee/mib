        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4">
                    ...
                    <div class="social-links">
                        <a href="https://www.instagram.com/mangueirasdeincendiobrasil/" target="_blank" class="social-link" title="Instagram"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/company/mangueirasdeincendiobrasil/" target="_blank" class="social-link" title="LinkedIn"><i class="fab fa-linkedin"></i></a>
                        <a href="https://www.tiktok.com/@mangueirasincendio2025" target="_blank" class="social-link" title="TikTok"><i class="fab fa-tiktok"></i></a>
                        <a href="https://www.youtube.com/@MangueirasDeIncendioBrasil" target="_blank" class="social-link" title="YouTube"><i class="fab fa-youtube"></i></a>
                        <!-- Links comentados para atualização futura -->
                        <!-- <a href="#" target="_blank" class="social-link" title="Twitter"><i class="fab fa-twitter"></i></a> -->
                        <!-- <a href="#" target="_blank" class="social-link" title="Facebook"><i class="fab fa-facebook"></i></a> -->
                        <a href="https://api.whatsapp.com/send?phone=5511940258669&text=Vim pelo site e gostaria de mais informações sobre seus produtos." target="_blank" class="social-link" title="WhatsApp" onclick="dataLayer.push({'event': 'whatsapp_click', 'event_category': 'contact', 'event_action': 'whatsapp_click', 'event_label': 'footer_whatsapp'});"><i class="fab fa-whatsapp"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="footer-links">
                        <li><a href="/equipamentos/mangueiras-de-incendio.php" style="color: #fff;">Mangueiras</a></li>
                        <li><a href="/equipamentos/extintores-de-incendio.php" style="color: #fff;">Extintores</a></li>
                        <li><a href="/equipamentos/esguichos-para-equipamentos-contra-incendio.php" style="color: #fff;">Esguichos</a></li>
                        <li><a href="/equipamentos/hidrante-contra-incendio.php" style="color: #fff;">Hidrantes</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="footer-links">
                        <li><a href="/empresa.php" style="color: #fff;">Sobre Nós</a></li>
                        <li><a href="/novidades/" style="color: #fff;">Novidades</a></li>
                        <li><a href="/contact.php" style="color: #fff;">Contato</a></li>
                        <li><a href="/privacy.php" style="color: #fff;">Política de Privacidade</a></li>
                        <li><a href="/all-links.php" style="color: #fff;">Veja nossos produtos</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="contact-info">
                        ...
                        <p><i class="fas fa-envelope me-2"></i><a href="mailto:contato@mangueirasdeincendiobrasil.com.br" style="color: #fff;" onclick="dataLayer.push({'event': 'email_click', 'event_category': 'contact', 'event_action': 'email_click', 'event_label': 'footer_email'});">contato@mangueirasdeincendiobrasil.com.br</a></p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="text-light mb-0">Desenvolvido por <a href="#" style="color: #fff;">Biss Solutions</a></p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <div class="whatsapp-float">
        <a href="https://api.whatsapp.com/send?phone=5511940258669&text=Vim pelo site e gostaria de mais informações sobre seus produtos." target="_blank" class="whatsapp-link">
    ...
    <div id="cookie-banner" class="cookie-banner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <p class="mb-0">Utilizamos cookies para melhorar sua experiência. Ao continuar navegando, você concorda com nossa <a href="/privacy.php" style="color: #fff;">Política de Privacidade</a>.</p>
                </div>
